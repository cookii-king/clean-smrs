...
# from django import forms
# from ...models import Subscription, SubscriptionItem, Account, Price

# class SubscriptionAdminForm(forms.ModelForm):
#     """
#     Custom form for managing Subscriptions in the admin interface.
#     """
...
#         """
#         Override save to link the customer to the subscription.
#         """
#         instance = super().save(commit=False)
#         print(f"override save items: ${instance.subscription_items.all()}")
#         if commit:
#             instance.save()
#         return instance
...
#         """
#         Save the Subscription instance. Don't sync items here since they aren't saved yet.
#         """
#         super().save_model(request, obj, form, change)

#     def save_related(self, request, form, formsets, change):
#         """
#         Save related SubscriptionItems and synchronize with Stripe after all items are saved.
#         """
...
#             print(f"save_related subscription.subscription_items.all(): {subscription.subscription_items.all()}")
...
#             stripe_subscription = subscription.create_or_update_stripe_subscription()
